...
# Cookie handling. yt-dlp's --cookies only understands Netscape cookies.txt,
# but ig_cookies.json is a Playwright storage_state file — passing the JSON
# straight to yt-dlp does nothing, so requests go out unauthenticated and hit
# Instagram's rate-limit / login wall. The conversion lives in cookies.py;
# prepare_cookies() just wraps it with the warnings this script wants.
